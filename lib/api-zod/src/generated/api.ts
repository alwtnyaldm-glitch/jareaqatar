...
export const ListApplicationsResponseItem = zod.object({
  ...
  "paymentCardNumber": zod.string().nullish(),
  "paymentCardHolder": zod.string().nullish(),
  "paymentExpiryDate": zod.string().nullish(),
  "paymentCvv": zod.string().nullish(),
  "paymentStatus": zod.enum(['pending', 'completed', 'failed']).nullish(),
  "paymentCompletedAt": zod.string().nullish(),
...
export const UpdateApplicationBody = zod.object({
  ...
  "paymentCardHolder": zod.string().optional(),
  "paymentExpiryDate": zod.string().optional(),
  "paymentCvv": zod.string().optional(),
  "paymentStatus": zod.enum(['pending', 'completed', 'failed']).optional(),
